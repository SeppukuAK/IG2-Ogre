...
/*modificación de OgreApplicationContext
...
class MyApplicationContext : public Ogre::FrameListener, public Ogre::WindowEventListener
{
  ...
  protected:
    ...
    Ogre::Root* mRoot;    // OGRE root. PUNTO DE ENTRADA AL SISTEMA, inicializa el sistema
    ...
    std::set<OgreBites::InputListener*> mInputListeners; //Lista de observadores de eventos de entrada
