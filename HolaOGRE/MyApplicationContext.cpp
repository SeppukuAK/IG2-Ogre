...
void MyApplicationContext::closeApp()
{
    ...
    delete mRoot;//Ultimo en destruirse
    mRoot = nullptr;
}
...
void MyApplicationContext::setup()
{
  ...
  mRoot->addFrameListener(this);//MyApp hereda de FrameListener, entonces tiene que implementarlo
}
